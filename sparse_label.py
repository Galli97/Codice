...
for j in range (N-A):
    ...
    for i in range(0,63):
        for n in range(0,63): 
            ...
            #print(channels_xy)
            if any(channels_xy==bedrock):      #BEDROCK      
                new_label[i,n,0]=0
                print('bed rock: ',channels_xy)
            elif any(channels_xy==sand):    #SAND
                new_label[i,n,0]=1
                print('bed rock: ',channels_xy)
            elif any(channels_xy==bigrock):    #BIG ROCK
                new_label[i,n,0]=2
            elif any(channels_xy==soil):    #SOIL
                new_label[i,n,0]=3
            elif any(channels_xy==nullo):    #NULL
                new_label[i,n,0]=4
