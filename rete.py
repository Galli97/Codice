...
def rete(input_shape=None, weight_decay=0., batch_shape=None, classes=5):
    ...
    # Block 4
    x = Conv2D(512, (3, 3), activation='relu', padding='same',dilation_rate=(2,2), name='block5_conv1', kernel_regularizer=l2(weight_decay))(x)
    x = Conv2D(512, (3, 3), activation='relu', padding='same',dilation_rate=(2,2), name='block5_conv2', kernel_regularizer=l2(weight_decay))(x)
    x = Conv2D(512, (3, 3), activation='relu', padding='same',dilation_rate=(2,2), name='block5_conv3', kernel_regularizer=l2(weight_decay))(x)
    #x = tf.keras.layers.BatchNormalization()(x)##########
