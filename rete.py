...
def rete(input_shape=None, weight_decay=0., batch_shape=None, classes=5):
    ...
    x = Dropout(0.5)(x)
    x = Conv2D(classes, (3, 3),  kernel_initializer='normal',activation='relu', padding='same', strides=(1, 1), kernel_regularizer=l2(weight_decay))(x)
...
def build_vgg16_unet(input_shape,weight_decay=0.,classes=5):
    ...
    b2 = Dropout(0.5)(b2)
    b3 = Conv2D(classes, (3, 3),  kernel_initializer='normal', activation='relu', padding='same', strides=(1, 1), kernel_regularizer=l2(weight_decay))(b2)
