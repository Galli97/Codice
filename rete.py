...
def build_vgg16_unet(input_shape,weight_decay=0.,classes=5):
    ...
    b1 = Conv2D(512, (3, 3), activation='relu', padding='same',dilation_rate=(4,4), name='block4_conv1', kernel_regularizer=l2(weight_decay))(x)
    b1 = Conv2D(512, (3, 3), activation='relu', padding='same',dilation_rate=(4,4), name='block4_conv2', kernel_regularizer=l2(weight_decay))(b1)
    b1 = Conv2D(512, (3, 3), activation='relu', padding='same',dilation_rate=(4,4), name='block4_conv3', kernel_regularizer=l2(weight_decay))(b1)         ## (32 x 32)
    s4 = b1 
