...
def rete(input_shape=None, weight_decay=0., batch_shape=None, classes=5):
    ...
    # Block 5
    x = Conv2D(512, (3, 3), activation='relu', padding='same',dilation_rate=(10,10), name='fc3', kernel_regularizer=l2(weight_decay))(x)
    x = BatchNormalization()(x)
    x = Dropout(0.5)(x)
    x = Conv2D(512, (3, 3), activation='relu', padding='same', name='fc4', kernel_regularizer=l2(weight_decay))(x)
    x = BatchNormalization()(x)
    x = Dropout(0.5)(x)
...
def build_vgg16_unet(input_shape,weight_decay=0.,classes=5):
    ...
    b2 = Conv2D(128, (3, 3), activation='relu', padding='same',dilation_rate=(10,10), name='fc5', kernel_regularizer=l2(weight_decay))(b1_pooling)
    x = BatchNormalization()(x)
    b2 = Dropout(0.5)(b2)
    b2 = Conv2D(128, (3, 3), activation='relu', padding='same', name='fc6', kernel_regularizer=l2(weight_decay))(b2)
    x = BatchNormalization()(x)
    b2 = Dropout(0.5)(b2)
