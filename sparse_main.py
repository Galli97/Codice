...
#model.summary()
model.fit(x = x_train,batch_size = 16,epochs=25,steps_per_epoch=25,validation_data=(list_validation, label_validation),validation_steps=25,validation_batch_size=16)