...
#model.summary()
model.fit(x = x_train,batch_size = BATCH,epochs=25,steps_per_epoch=4,validation_data=(list_validation, label_validation),validation_steps=4,validation_batch_size=BATCH)