...
callbacks = [scheduler]
callbacks.append(tf.keras.callbacks.EarlyStopping(monitor='val_updated_mean_io_u', min_delta=0.001,verbose=1,mode="max",restore_best_weights=False, patience=40))
