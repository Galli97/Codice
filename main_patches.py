...
x_train = tf.data.Dataset.from_generator(datagenerator(list_train,label_train,BATCH))
x_validation = tf.data.Dataset.from_generator(datagenerator(list_validation,label_validation,BATCH))
