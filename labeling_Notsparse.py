...
path = r"C:\Users\Mattia\Desktop\TentativiBR_128\DATASET\cropped_images.npy"
path1 = r"C:\Users\Mattia\Desktop\TentativiBR_128\DATASET\cropped_labels.npy"
path2 = r"C:\Users\Mattia\Desktop\TentativiBR_128\DATASET\cropped_images_2.npy"
path3 = r"C:\Users\Mattia\Desktop\TentativiBR_128\DATASET\cropped_labels_2.npy"
path4 = r"C:\Users\Mattia\Desktop\TentativiBR_128\DATASET\cropped_images_3.npy"
path5 = r"C:\Users\Mattia\Desktop\TentativiBR_128\DATASET\cropped_labels_3.npy"
...
crop_images_list_2 = get_np_arrays(path2)          #recupero tmp1 dal file 
crop_labels_list_2 = get_np_arrays(path3)          #recupero tmp2 dal file

crop_images_list_3 = get_np_arrays(path4)          #recupero tmp1 dal file 
crop_labels_list_3 = get_np_arrays(path5)          #recupero tmp2 dal file

crop_images_list=np.concatenate((crop_images_list,crop_images_list_2,crop_images_list_3))
crop_labels_list=np.concatenate((crop_labels_list,crop_labels_list_2,crop_labels_list_3))
...
tmp2 = np.empty((N, SHAPE, SHAPE, num_classes), dtype=np.uint8)  #Qui ho N labels, che portano l'informazione per ogni pixel. Nel caso sparse avrò un intero ad indicare la classe
...
for t in range (0,len(crop_labels_list)):
    ...
    #     count+=1
        ...
        if (flag_bigrock==True and flag_sand==True):
            ...
            new_label = np.empty((SHAPE, SHAPE, num_classes), dtype=np.uint8)  #inizializzo una nuova lista che andrà a contenere le informazioni per ogni pixel
...
print('tmp3[0]: ', tmp3[0])
print('tmp2[0]: ',tmp2[0])
masks=decode_masks_Notsparse(tmp2,SHAPE)
