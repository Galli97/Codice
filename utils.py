...
def add_sample_weights(image, label):
    ...
    class_weights = tf.constant([0,PIXELS/bedrock_pixels,0.2+PIXELS/sand_pixels,PIXELS/bigrock_pixels,PIXELS/soil_pixels])
...
def add_sample_weights_val(image, label):
    ...
    # #128 1
    # null_pixels = 1603190  
    # bedrock_pixels =  2258904 
    # sand_pixels =  1854016 
    # bigrock_pixels =  433585 
    # soil_pixels = 666049 

    #128 1+2
    # null_pixels = 1598286  
    # bedrock_pixels =  3640209 
    # sand_pixels =  2875342 
    ...
    #128_2 1 
    # null_pixels = 771230  
    # bedrock_pixels =  1836013 
    # sand_pixels =  1344754 
    # bigrock_pixels =  261870 
    # soil_pixels = 291733 

    #128_2 1+2 
    # null_pixels = 1279660  
    # bedrock_pixels =  3102743 
    # sand_pixels =  2188279 
    # bigrock_pixels =  365164 
    # soil_pixels = 666330 
